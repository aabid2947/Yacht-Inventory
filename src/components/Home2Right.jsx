      ...
      {selectedItems.length === 3 && (
        <div className="fixed bottom-8 right-8 z-50">
          <Button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-xl text-lg font-semibold flex items-center gap-2"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068M15.75 21H8.25A2.25 2.25 0 016 18.75V5.25A2.25 2.25 0 018.25 3h7.5A2.25 2.25 0 0118 5.25v8.25A2.25 2.25 0 0115.75 21v-2.25a2.25 2.25 0 00-1.5-2.122M15.75 21V15.75M3 12c0-1.268.63-2.39 1.593-3.068M3 12a9 9 0 0118 0M3 12a9 9 0 0018 0" />
            </svg>
            Compare ({selectedItems.length} Boats)
          </Button>
        </div>
      )}
    </div>
