...
function PaginationControls({
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-[6px] items-center w-full sm:w-auto justify-center sm:justify-end">
        <button
      ...
      <div className="flex gap-2.5 items-center w-full sm:w-auto justify-center">
        ...
        <input
          ...
          className="h-9 text-sm sm:text-base rounded-md border border-[#000000A6] border-opacity-50 text-[#000000A6] text-opacity-70 w-[72px] text-center"
